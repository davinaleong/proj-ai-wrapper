...
export const FILE_QA_BANK = [
...

  {
    ...
    reply:
      "Here’s the **Quarterly Operations Summary (dummy.docx)**. \n\nHighlights: planned maintenance completed on schedule; filter optimisation reduced turbidity variance; no long-duration outages.\n\n• Use: Reference for management updates.\n• Notes: Data is demo-only.",
  },
...

  {
    ...
    reply:
      "Attached is the **Weekly Chlorine Residuals chart (dummy.jpg)**. \n\nJune spike reflects preventive dosing during maintenance.\n\n• Use: Show trend during toolbox talks.\n• Notes: Placeholder image for demo.",
  },
];
